...
const RecommendedBakugan = ({ onToggle }: RecommendedBakuganProps) => {
  ...
  // Update loading state based on image preloading - make it MUCH faster
  useEffect(() => {
    // As soon as we have recommendations data, show content immediately
  ...
  // ไม่ใช้ loading state แบบเต็มหน้าอีกต่อไป เพื่อให้แสดงเนื้อหาเร็วขึ้น
  ...
  return (
    <div className={baseClasses}>
      ...
      {!allImagesLoaded ? (
        ...
        // 3D Carousel only after images are loaded
        <div 
